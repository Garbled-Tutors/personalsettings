...
defbindings("WTiling", {
    ...
    --kpress(META.."Shift+Up", "WTiling.split_top(_, 'bottom')"),
    ...
    --kpress(META.."Shift+Up", "ioncore.goto_next(_sub, 'up', {no_ascend=_})"),
    --kpress(META.."Shift+Down", "ioncore.goto_next(_sub, 'down', {no_ascend=_})"),
